...
public class ThreadProcess implements Runnable{
	...
	public ThreadProcess(int segmentPMN, int segmentVMN,int []segvmCPU,int []segvmRAM,int []segpmCPU,int []segpmRAM,int []staticpower , int [][]DYP){
		this.PMN = segmentPMN;
		this.VMN = segmentVMN;
		this.vmCPU = segvmCPU;
		this.vmRAM = segvmRAM;
	...
	public void run(){
		...
		s.minimize(false);                                                          //false表示当无法求得最小的power时，不重新搜索
